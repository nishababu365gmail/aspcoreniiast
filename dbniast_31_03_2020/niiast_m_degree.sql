...
CREATE TABLE `m_degree` (
  ...
  UNIQUE KEY `DegreeName_UNIQUE` (`DegreeName`)
...
INSERT INTO `m_degree` VALUES (5,'BA Economics'),(1,'BSc IT'),(2,'BSc Maths'),(4,'MCA'),(3,'MSc IT');
...
-- Dump completed on 2020-03-31 18:34:52
